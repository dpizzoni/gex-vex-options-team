...
const WORKFLOW_FILE = "gamma-intraday.yml";

// Same pattern as trigger-daily/route.ts, pointed at the intraday Gamma
// Regime refresh workflow instead - fires it precisely at 15:00/20:00 UTC
// instead of waiting on GitHub's own (delay-prone) schedule trigger.
